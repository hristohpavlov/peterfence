    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="icon" href="/static/peterfence-only-logo-2.png" />
                <meta charSet="UTF-8" />
            ...
            <Navbar collapseOnSelect sticky="top" expand="lg" bg="dark" variant="dark" className={classNames(scrolling ? "active" : "transparent")}>
                <Container style={{ maxWidth: "unset" }}>
                    ...
                    {currTheme === 'light' && <Navbar.Brand href="/"><img src="/static/peterfence-only-logo.png" style={{maxHeight: '50px', minWidth: '60px', marginTop: '-10px', marginBottom: '-10px'}}/></Navbar.Brand>}
